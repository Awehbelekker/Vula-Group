...
const s = {
  ...
  userBubble:  { background: 'var(--accent, #2C5545)', color: '#fff', borderBottomRightRadius: 4 },
  ...
  suggestion:  { padding: '7px 12px', borderRadius: 16, border: '1px solid #DDD8CE', background: '#fff', cursor: 'pointer', fontSize: 12, fontFamily: 'system-ui', color: 'var(--accent, #2C5545)' },

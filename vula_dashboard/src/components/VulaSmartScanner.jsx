...
function Field({ label, value, accent }) {
  return (
    <div style={s.field}>
      ...
      <span style={{ ...s.fieldValue, ...(accent ? { color: '#2C5545', fontWeight: 700 } : {}) }}>{value}</span>
    </div>
  )
}
...
const s = {
  ...
  captureBtn:   { display: 'block', textAlign: 'center', padding: '32px 16px', border: '2px dashed #2C5545', borderRadius: 12, cursor: 'pointer', fontSize: 16, fontFamily: 'system-ui', fontWeight: 600, color: '#2C5545', background: 'rgba(44,85,69,0.04)' },
  ...
  scanningOverlay: { position: 'absolute', inset: 0, background: 'rgba(247,244,238,0.85)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'system-ui', fontSize: 15, fontWeight: 600, color: '#2C5545', borderRadius: 8 },
  ...
  detectedBadge:{ fontFamily: 'system-ui', fontSize: 11, color: '#2C5545', background: 'rgba(44,85,69,0.1)', padding: '4px 10px', borderRadius: 12, fontWeight: 600 },
  ...
  btnPrimary:   { padding: '12px', background: '#2C5545', color: '#fff', border: 'none', borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: 'pointer', fontFamily: 'system-ui' },
  btnSecondary: { padding: '12px', background: 'transparent', color: '#2C5545', border: '1px solid #2C5545', borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: 'pointer', fontFamily: 'system-ui' },

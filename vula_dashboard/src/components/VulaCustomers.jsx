...
const s = {
  ...
  segActive: { background: '#2C5545', color: '#fff', border: '1px solid #2C5545' },
  ...
  reach:     { fontFamily: 'system-ui', fontSize: 12, color: '#2C5545', background: 'rgba(44,85,69,0.07)', padding: '8px 12px', borderRadius: 6, margin: '0 0 12px' },
  ...
  avatar:    { width: 34, height: 34, borderRadius: '50%', background: '#2C5545', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'system-ui', fontWeight: 700, fontSize: 14, flexShrink: 0 },
  ...
  spent:     { fontFamily: 'system-ui', fontSize: 14, fontWeight: 700, color: '#2C5545' },

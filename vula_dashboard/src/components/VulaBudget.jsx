...
const s = {
  ...
  addBtn:     { padding: '7px 14px', background: '#2C5545', color: '#fff', border: 'none', borderRadius: 6, fontSize: 13, cursor: 'pointer', fontFamily: 'system-ui', fontWeight: 600 },
  ...
  saveBtn:    { padding: '9px', background: '#2C5545', color: '#fff', border: 'none', borderRadius: 6, fontSize: 13, fontWeight: 600, cursor: 'pointer', fontFamily: 'system-ui' },
